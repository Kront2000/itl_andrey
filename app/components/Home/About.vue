...
<template>
    ...
    <section v-else-if="about && about?.data.length > 0" class="w-full rounded-lg p-10 flex flex-col-reverse xl:flex-row justify-between items-center gap-13 border border-blue/20">
