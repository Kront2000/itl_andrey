...
<template>
    <section class="flex flex-col gap-10">
        ...
        <p v-if="pending || !data || data.data.length < 1" class="text-text-black">Мы ценим ваше мнение! Пожалуйста, поделитесь своими впечатлениями о продукте. Ваш
        ...
        <UButton v-if="pending || !data || data.data.length < 1" class="max-w-96" :ui="{ base: 'text-base py-[12px] px-[20px] bg-yelow hover:bg-yelow/80 text-text-black' }">Написать отзыв
        </UButton>
    </section>
</template>
